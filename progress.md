...
- Session 2026-09-16: Implemented Multi-Monitor Wallpaper Resume-Sync on Monitor Uncover without touching stable transition engine. Validated frame-accurate catch-up across local videos (10s, 30s, 60s) and YouTube VODs with telemetry difference reporting. Verified zero seek on different wallpapers, YouTube Live, and when setting is OFF. Clean build on Vite 8 & Tauri 2 Rust backend.
